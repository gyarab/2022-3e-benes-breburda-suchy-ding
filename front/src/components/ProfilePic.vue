...
const props = defineProps({user: String, size: String})
...
<template>
    <div class="flex border-2 border-[#1D1D2A] rounded-full overflow-hidden items-center justify-center" :class="[`w-${props.size}`, `h-${props.size}`]">
